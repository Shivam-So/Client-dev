...
import { LayoutDashboard, Users, FileText, UsersRound, UserPlus, Settings, Menu, X } from "lucide-react";
...
export default function AdminLayout() {
    ...
    return (
        <div className="flex h-screen overflow-hidden" style={{ background: "#0f1117" }}>
            ...
            {/* Desktop Sidebar */}
            <div className="hidden md:flex w-64 flex-col p-4 border-r" style={{ background: "#151921", borderColor: "#1e2433" }}>
                <SidebarContent />
            </div>
            ...
            {sidebarOpen && (
                <div className="fixed inset-0 z-50 md:hidden">
                    ...
                    />
                    {/* Sidebar */}
                    <div className="absolute left-0 top-0 h-full w-64 flex flex-col p-4 border-r z-50"
                        style={{ background: "#151921", borderColor: "#1e2433" }}>
                        <button
                            onClick={() => setSidebarOpen(false)}
            ...
            <div className="flex-1 overflow-y-auto" style={{ background: "#0f1117" }}>
                {/* Topbar */}
                <div className="flex justify-between items-center px-4 md:px-6 py-4 border-b" style={{ background: "#151921", borderColor: "#1e2433" }}>
