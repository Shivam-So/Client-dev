    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4 mb-6">
                <div className="p-4 md:p-5 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-2xl cursor-pointer" style={cardStyle}>
                    <div className="flex items-center gap-2 md:gap-3 mb-3">
                        <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center transition-all duration-300 hover:rotate-6 hover:scale-110" style={{ background: "#1e3a5f" }}>
                    ...
                    <div className="mt-3 h-1 rounded-full" style={{ background: "#1e2433" }}>
                        <div className="h-1 rounded-full transition-all duration-500 hover:w-[80%]" style={{ background: "#3b82f6", width: "60%" }}></div>
                    </div>
                </div>

                <div className="p-4 md:p-5 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-2xl cursor-pointer" style={cardStyle}>
                    <div className="flex items-center gap-2 md:gap-3 mb-3">
                        <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center transition-all duration-300 hover:rotate-6 hover:scale-110" style={{ background: "#1a2e1a" }}>
                    ...
                    <div className="mt-3 h-1 rounded-full" style={{ background: "#1e2433" }}>
                        <div className="h-1 rounded-full transition-all duration-500 hover:w-[70%]" style={{ background: "#4ade80", width: "40%" }}></div>
                    </div>
                </div>
            </div>

            <div className="transition-all duration-300 hover:shadow-2xl" style={cardStyle}>
                <div className="flex items-center justify-between px-4 md:px-5 py-4 border-b" style={{ borderColor: "#1e2433" }}>
                    ...
                    <span className="text-xs px-2 py-1 rounded-full transition-all duration-300 hover:scale-105" style={{ background: "#1e3a5f", color: "#60a5fa" }}>
                        Latest 7 {/* ← 7 kiya */}
                    </span>
                </div>
                            ...
                            {users.length === 0 ? (
                                ...
                                users.map((user, i) => (
                                    <tr key={i} style={{ borderBottom: "1px solid #1e2433" }}>
                                        <td className="px-4 md:px-5 py-3 text-sm font-medium transition-all duration-300 hover:bg-[#111827] hover:text-blue-400 hover:scale-[1.03] hover:shadow-2xl cursor-pointer" style={textWhite}>{user.name}</td>
                                        <td className="px-4 md:px-5 py-3 text-sm transition-all duration-300 hover:bg-[#111827] hover:text-white hover:scale-[1.03] hover:shadow-2xl cursor-pointer" style={textMuted}>{user.email}</td>
                                        <td className="px-4 md:px-5 py-3 text-sm transition-all duration-300 hover:bg-[#111827] hover:text-white hover:scale-[1.03] hover:shadow-2xl cursor-pointer" style={textMuted}>{user.contact || "N/A"}</td>
                                        <td className="px-4 md:px-5 py-3 text-sm transition-all duration-300 hover:bg-[#111827] hover:text-white hover:scale-[1.03] hover:shadow-2xl cursor-pointer" style={textMuted}>{new Date(user.createdAt).toLocaleDateString()}</td>
                                    </tr>
                                ))
                            )}
                        </tbody>
