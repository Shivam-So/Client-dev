...
export default function AdminDashboard() {
    ...
    return (
        <div>
            <h1 className="text-xl md:text-2xl font-bold mb-1" style={textWhite}>
                Dashboard
            </h1>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4 mb-6">
                ...
                {/* Total Users */}
                <div
                    className="p-4 md:p-5 transition-all duration-300 ease-in-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-2xl cursor-pointer"
                    style={cardStyle}
                >
                    <div className="flex items-center gap-2 md:gap-3 mb-3">

                        <div
                            className="w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center transition-all duration-300 hover:rotate-6 hover:scale-110"
                            style={{ background: "#1e3a5f" }}
                        >
                            <UsersIcon size={18} color="#60a5fa" />
                        </div>

                        <p className="text-xs md:text-sm" style={textMuted}>
                            Total Users
                        </p>
                    </div>

                    <p className="text-2xl md:text-3xl font-bold" style={textWhite}>
                        {totalUsers}
                    </p>

                    <div className="mt-3 h-1 rounded-full" style={{ background: "#1e2433" }}>
                        <div
                            className="h-1 rounded-full transition-all duration-500 hover:w-[80%]"
                ...
                >
                    ...
                    <div className="mt-3 h-1 rounded-full" style={{ background: "#1e2433" }}>
                        <div
                            className="h-1 rounded-full transition-all duration-500 hover:w-[70%]"
                            style={{ background: "#4ade80", width: "40%" }}
                        ></div>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                >
                    <h2 className="font-semibold text-sm md:text-base" style={textWhite}>
                        Recent Users
                    </h2>
                        ...
                        <thead>
                            <tr style={{ borderBottom: "1px solid #1e2433" }}>
                                {["Name", "Email", "Contact", "Created At"].map(h => (
                                    <th
                                        key={h}
                                        className="px-4 md:px-5 py-3 text-xs font-semibold uppercase"
                                        style={{ color: "#4b5563" }}
                                    >
                                        {h}
                                    </th>
                            ...
                            {users.length === 0 ? (
                                ...
                                users.map((user, i) => (
                                    ...
                                    >
                                        ...
                                        <td
                                            className="
                                            px-4 md:px-5 py-3 text-sm font-medium
